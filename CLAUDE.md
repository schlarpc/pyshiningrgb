...
- `pyshiningrgb` - Run the CLI application directly
- `python -m pyshiningrgb` - Run the module as a script
...
- `nix run .#container.copyTo -- docker-daemon:pyshiningrgb:latest` - Copy container using Skopeo
...
- **src/pyshiningrgb/**: Main package source code
